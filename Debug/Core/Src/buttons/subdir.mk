...
../Core/Src/buttons/buttons_process.c 

OBJS += \
./Core/Src/buttons/buttons.o \
./Core/Src/buttons/buttons_process.o 

C_DEPS += \
./Core/Src/buttons/buttons.d \
./Core/Src/buttons/buttons_process.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Src/buttons/%.o Core/Src/buttons/%.su Core/Src/buttons/%.cyclo: ../Core/Src/buttons/%.c Core/Src/buttons/subdir.mk
...
clean-Core-2f-Src-2f-buttons:
	-$(RM) ./Core/Src/buttons/buttons.cyclo ./Core/Src/buttons/buttons.d ./Core/Src/buttons/buttons.o ./Core/Src/buttons/buttons.su ./Core/Src/buttons/buttons_process.cyclo ./Core/Src/buttons/buttons_process.d ./Core/Src/buttons/buttons_process.o ./Core/Src/buttons/buttons_process.su
